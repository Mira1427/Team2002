...
// 敵設定
void EnemySpawnerBehavior::Enemy(GameObject* obj, EnemySpawnerComponent* spawner, float life, int color, int angle)
{
	// --- オブジェクトの追加 ---
	GameObject* enemy = GameObjectManager::Instance().Add(
		std::make_shared<GameObject>(),
